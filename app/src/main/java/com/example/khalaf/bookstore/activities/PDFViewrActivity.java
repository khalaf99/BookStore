...
public class PDFViewrActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Get the Book Object
        book = (Book) getIntent().getSerializableExtra(ActivityLauncter.BOOK_KEY);
    ...
    private void downloadBookPDF(String bookId) {
        ...
        FirebaseStorage.getInstance()
                .getReference(Constans.BOOK_PDF_FOLDER).child(bookId + ".pdf").getFile(localFile)
            ...
            public void onFailure(@NonNull Exception exception) {
                progress.setVisibility(View.GONE);
                //If file not exists
                Toast.makeText(PDFViewrActivity.this, "Error In Download PDF", Toast.LENGTH_SHORT).show();
            }
        });
    }
