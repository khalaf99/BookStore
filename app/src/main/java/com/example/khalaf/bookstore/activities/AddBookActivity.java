...
public class AddBookActivity extends AppCompatActivity implements View.OnClickListener, DatePickerDialog.OnDateSetListener {
    ...
    Button btnBookDate, btnAddPdfFile, btnAddNewBook;
    ImageView ivBook;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBookDate = (Button) findViewById(R.id.btn_book_date);
        btnAddPdfFile = (Button) findViewById(R.id.btn_add_pdf_file);
        btnAddNewBook = (Button) findViewById(R.id.btn_add_new_book);
        ...
        etBookDesc = (EditText) findViewById(R.id.et_book_desc);
    ...
    private void addNewbook() {
        ...
        Utilities.showLoadingDialog(AddBookActivity.this, Color.WHITE);
        ...
        String bookid = FirebaseDatabase.getInstance().getReference(Constans.REF_BOOK).push().getKey();
        book = new Book(bookid, title, Desc, price, publisherid ,date ,pdftitle);
        UploadpdfFile();
    }
    ...
    private void uploadBookImage() {
        Uri photoURI = FileProvider.getUriForFile(AddBookActivity.this, "com.example.khalaf.bookstore.Fileprovider", imageFile);
        FirebaseStorage.getInstance()
                .getReference()
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(AddBookActivity.this, "error_in_connection", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (which == 0) {
                            ...
                            if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
                                ...
                                if (photoFile != null) {
                                    Uri photoURI = FileProvider.getUriForFile(AddBookActivity.this, "com.example.khalaf.bookstore.Fileprovider", photoFile);
